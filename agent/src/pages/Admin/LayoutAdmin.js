  ...
  return (
    <Box sx={{ display: "flex" }}>
      ...
      <Drawer variant="permanent" drawerOpen={drawerOpen}>
        ...
        <Divider />
        <List>
          <Link to={user?.role === "penjual" ? `../${id}/seller` : `../${id}/admin`}>
          ...
          {user?.role === "penjual" ? (
             <>
             <Link to={`../${id}/seller/order`}>
               <ListItemButton className="bg-blue-500 border-emerald-50">
                 <ListItemText primary="Orders" />
               </ListItemButton>
             </Link>
             <Link to={`../${id}/seller/comments`}>
               <ListItemButton className="bg-blue-500 border-emerald-50">
            ...
            <>
              <Link to={`../${id}/admin/orders`}>
                <ListItemButton className="bg-blue-500 border-emerald-50">
                  <ListItemText primary="Orders" />
                </ListItemButton>
              </Link>
              <Link to={`../${id}/admin/users`}>
                <ListItemButton className="bg-blue-500 border-emerald-50">
                  <ListItemText primary="Users" />
                </ListItemButton>
              </Link>
              <Link to={`../${id}/admin/comments`}>
                <ListItemButton className="bg-blue-500 border-emerald-50">
                  <ListItemText primary="Comments" />
                </ListItemButton>
              </Link>
